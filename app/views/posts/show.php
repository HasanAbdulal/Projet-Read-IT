...
/*
    ...
    Variables disponibles :
        - $post ARRAY(id, title, content, created_at, image, resume)
        - $tags ARRAY(ARRAY(id, name))
        - $author ARRAY (id, firstname, lastname, biography, image)
        - $comment ARRAY(ARRAY(id, pseudo, content, created_at))
*/
?>
<p class="mb-5">
...
<div class="pt-5 mt-5">
    ...
    <!-- Start Commants Formailaire--> 
    <?php include '../app/views/comments/_form.php'; ?>
    <!-- End Comments Formailaire--> 
</div>